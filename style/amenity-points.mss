@marina-text: #0000ff; // also swimming_pool
@wetland-text: #000; //darken(#4aa5fa, 25%); /* Also for mud */
@shop-icon: #ac39ac;
@shop-text: #939;
@transportation-icon: #0000ff;
@transportation-text: #000000;
@accommodation-icon: @transportation-icon;
@accommodation-text: @transportation-text;
@airtransport: #8461C4; //also ferry_terminal
@health-color: #FF0000;
@amenity-brown: #FFF700;
@gastronomy-icon: #C77400;
@gastronomy-text: #000; //darken(@gastronomy-icon, 5%);
