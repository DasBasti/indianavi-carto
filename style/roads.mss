...
@pedestrian-fill: #f7fff7;
@raceway-fill: #bf003f;
@road-fill: #ffff7f;
@footway-fill: #ffbf7f;
@footway-fill-noaccess: #bfbfbf;
@steps-fill: @footway-fill;
@steps-fill-noaccess: #bfbfbf;
@cycleway-fill: blue;
@cycleway-fill-noaccess: #007f7f;
@bridleway-fill: #00ff00;
@bridleway-fill-noaccess: #00ff3f;
@track-fill: #ff7f00;
@track-fill-noaccess: #ffbf7f;
@aeroway-fill: #7f7f7f;
@runway-fill: @aeroway-fill;
@taxiway-fill: @aeroway-fill;
@helipad-fill: @aeroway-fill;
@access-marking: #ffffff;
@access-marking-living-street: #7f7f7f;

@default-casing: white;
@tertiary-casing: #3f3f3f;
@residential-casing: #7f7f7f;
@road-casing: @residential-casing;
@service-casing: @residential-casing;
@living-street-casing: @residential-casing;
@pedestrian-casing: #bfbfbf;
...
@tertiary-shield: #3f3f3f;

@unimportant-road: @residential-casing;

@minor-construction: #bfbfbf;
@service-construction: #bfbfbf;

@destination-marking: #007f7f;
@private-marking: #ff7f7f;
@private-marking-for-red: #bf003f;

@tunnel-casing: #bfbfbf;
...
@junction-text-color:             #000;
@halo-color-for-minor-road:       black;
